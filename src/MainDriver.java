...
//			System.out.println("========Next Scenario=========");
	...
	public String run_engine(String option) throws IOException {
		...
		if (option.equals("김xx_2018_04_30"))
			scenarios = fileUtil.readScenario("Scenario/Tag 데이터 분단위 정렬/2018_04_김차순/Tag_김차순_cam0_2018_04_30.txt");
		else if (option.equals("도xx_2018_04_26"))
			scenarios = fileUtil.readScenario("Scenario/Tag 데이터 분단위 정렬/2018_04_도경자/Tag_도경자 거실)_2018_04_26.txt");
		else
			scenarios = fileUtil.readScenario("Scenario/Tag 데이터 분단위 정렬/2018_03_이숙재/Tag_이숙재_2018_03_23.txt");
